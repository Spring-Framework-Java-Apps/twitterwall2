...
public class CountedBomController extends AbstractTwitterwallController {

    @RequestMapping("/bom/count")
    ...
    @Autowired
    public CountedBomController(CountedEntitiesService countedEntitiesService) {
