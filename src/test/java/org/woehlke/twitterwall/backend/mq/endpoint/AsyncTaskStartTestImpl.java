...
public class AsyncTaskStartTestImpl extends AbstractMqEndpointTest implements AsyncStartTaskTest {

    private static final Logger log = LoggerFactory.getLogger(AsyncTaskStartTestImpl.class);
